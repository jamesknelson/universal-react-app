...
const useNodeEnv = !!paths.appNodeIndexJs;
...
module.exports = function(webpackEnv, executionEnv) {
  ...
  return {
    ...
    entry: isEnvNode ? paths.appNodeIndexJs : [
    ...
    output: {
      ...
      filename: (isEnvProduction && isEnvWeb)
        ? 'static/js/[name].[contenthash:8].js'
        : (isEnvNode ? 'index.js' : 'static/js/bundle.js'),
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: (isEnvProduction && isEnvWeb)
        ? 'static/js/[name].[contenthash:8].chunk.js'
        : (isEnvNode ? '[name].chunk.js' : 'static/js/[name].chunk.js'),
    ...
    externals: isEnvWeb ? undefined : [
      ...
      nodeExternals(),
      // This file contains a list of all JS and CSS files that need to be
      // added to the generated HTML. It isn't bundled into the app, as it
      // won't be known until after the bundle has been generated.
    ...
    resolve: {
      ...
      extensions: (isEnvWeb ? paths.webModuleFileExtensions : paths.nodeModuleFileExtensions)
        .map(ext => `.${ext}`)
    ...
    plugins: [
      ...
      isEnvProduction &&
        new webpack.DefinePlugin({
          'process.env.HTML_TEMPLATE_PATH': 'require("path").join(__dirname, "index.html")',
        }),
